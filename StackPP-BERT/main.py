...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_hidden_dim', '-ehd', type=int, default=1024)
    parser.add_argument('--intent_embedding_dim', '-ied', type=int, default=32)
    parser.add_argument('--slot_embedding_dim', '-sed', type=int, default=128)
    parser.add_argument('--slot_decoder_hidden_dim', '-sdhd', type=int, default=768)
